...
**SQL Database**: SQL Database is configured to use [Transparent Data Encryption The Azure SQL Database instance uses the following database security measures:
